    ...
    <nav className="fixed top-0 w-full z-50 border-b border-white/10 bg-[#021631]/50 backdrop-blur-md">
      <div className="max-w-7xl mx-auto px-6 h-16 flex items-center justify-between">
        <a href="#" className="flex flex-col items-start justify-center hover:opacity-90 transition-opacity">
          ...
          <span className=" text-[14px] text-white leading-none mt-0.5">
            J
      ...
      <div className="max-w-3xl mx-auto px-6 relative z-10 text-center">
        ...
        <div className="glass-card p-8 md:p-10 rounded-3xl border border-white/10 relative overflow-hidden">
          ...
          <div className="text-left max-w-xl mx-auto bg-white/5 p-6 md:p-8 rounded-2xl border border-white/5">
            <h3 className="text-lg md:text-xl font-medium text-white/90 mb-5 italic  text-center">What goes into your final quote?</h3>

            <ul className="space-y-4 text-base md:text-lg text-white/80 italic ">
    ...
    <section id="about" className="py-32 relative overflow-hidden">
      <div className="max-w-7xl mx-auto px-6 relative z-10">
        ...
        >
          ...
          <p className="text-lg md:text-2xl text-white/80 italic  leading-relaxed mb-6">
          ...
          <p className="text-lg md:text-2xl text-white/80 italic  leading-relaxed">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-10 mb-14">
          ...
          <div className="col-span-2 md:col-span-1">
            ...
            <div className="flex gap-3">
              <a href="https://www.facebook.com/profile.php?id=61586675595638" target="_blank" rel="noopener noreferrer" className="w-9 h-9 rounded-lg bg-white/5 border border-white/10 flex items-center justify-center text-white/50 hover:text-white hover:bg-white/10 hover:border-white/20 transition-all">
